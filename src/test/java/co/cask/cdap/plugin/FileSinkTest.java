 ...
 */
public class FileSinkTest extends HydratorTestBase {
  ...
  public static void setupTest() throws Exception {
    ...
    addPluginArtifact(NamespaceId.DEFAULT.artifact("file-plugins", "1.0.0"),
  ...
  public void testFileSink() throws Exception {
    ...
    ETLStage sink = new ETLStage(FileSink.NAME, new ETLPlugin(
      FileSink.NAME,
      BatchSink.PLUGIN_TYPE,
      ImmutableMap.<String, String>builder()
        .put("path", outputDir.toUri().toString())
        .put("referenceName", "FileinkTest")
        .put("delimiter", "|")
        .build(),
      null));
  ...
  public void testAddingJobProperties() throws Exception {
    ...
    ETLStage sink = new ETLStage(FileSink.NAME, new ETLPlugin(
      ...
      ImmutableMap.<String, String>builder()
        .put("path", outputDir.toUri().toString())
        .put("referenceName", "FileSinkTest")
        .put("jobProperties", "{" +
    ...
    AppRequest<ETLBatchConfig> appRequest = new AppRequest<>(ETLBATCH_ARTIFACT, etlConfig);
    ApplicationId appId = NamespaceId.DEFAULT.app("FileTest-adding-jobproperties");
    ApplicationManager appManager = deployApplication(appId, appRequest);
